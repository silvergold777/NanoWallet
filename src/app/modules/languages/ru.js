function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('ru', {
        ...
        LINE_TX_DETAILS_MULTISIG_MIN_COSIG: 'Мин. количество соподписантов',
        ...
        IMPORTANCE_TRANSFER_MULTISIG_SELECT_MESSAGE: 'Пожалуйста, выберите multisig, чтобы показать свой статус',


        // CREATE MOSAIC MODULE
        MOSAIC_DEFINITION_TITLE: 'Создать мозаику',
        MOSAIC_DEFINITION_NAME: 'Определение транзакции мозаики',
        ...
        MOSAIC_DEFINITION_INITIAL_SUPPLY: 'Первоначальное обеспечение',
        MOSAIC_DEFINITION_MUTABLE_SUPPLY: 'Переменчивое снабжение',
        MOSAIC_DEFINITION_TRANSFERABLE: 'Переводимый',
        ...
        MOSAIC_DEFINITION_LEVY_SELECT_MOSAIC: 'выберите обложение мозаики',
        MOSAIC_DEFINITION_LEVY_ADDRESS: 'Адрес взноса',
        MOSAIC_DEFINITION_LEVY_FEE_TYPE: 'Тип оплаты',
        MOSAIC_DEFINITION_LEVY_FEE_TYPE_1: 'Absolute',
        MOSAIC_DEFINITION_LEVY_FEE_TYPE_2: 'Процентиль',
        MOSAIC_DEFINITION_LEVY_FEE_TYPE_1_NOTE: 'Выбор абсолютного, приведет к постоянному взиманию',
        MOSAIC_DEFINITION_LEVY_FEE_TYPE_2_NOTE: 'Выбор процентиль, вызовет линейный налог:',
        MOSAIC_DEFINITION_LEVY_FEE_TYPE_2_NOTE_2: 'Отправка',
        MOSAIC_DEFINITION_LEVY_FEE_TYPE_2_NOTE_3: 'Подразумевает взимать',
        MOSAIC_DEFINITION_PARENT: 'Пространство имен',
        MOSAIC_DEFINITION_INFORMATION_1: 'Максимальная длина имени для мозаики 32 символа. Допустимые символы:',
        MOSAIC_DEFINITION_INFORMATION_2: 'Первым символом должна быть буква.',
        MOSAIC_DEFINITION_INFORMATION_3: 'Описание не должно превышать 512 символов. Нет ограничений для символов используемых в описании.',
        MOSAIC_DEFINITION_INFORMATION_4: 'Поведение мозаики может быть настроена с помощью набора свойств:',
        ...
        MOSAIC_DEFINITION_INFORMATION_11: 'Получатель налога. Может быть любой аккаунт.',
        ...
        EXPLORER_NAV_NSM: 'Пространство имен & Мозаики',
        EXPLORER_NAV_APOSTILLES: 'Апостили',

        // EXPLORER HOME MODULE
        EXPLORER_HOME_TITLE: 'Проводник - Главная',
        ...
        ALERT_SUCCESS_PURGE: 'Локальное устройство успешно очищено !',
        ALERT_SUCCESS_LOGOUT: 'Успешно вышли !',
        ALERT_LOAD_WALLET_SUCCESS: 'Кошелек успешно загружен !',
        ALERT_TRANSACTION_SUCCESS: 'Транзакция успешно отправлена !',
        ALERT_GENERATE_ACCOUNT_SUCCESS: 'Аккаунт успешно создан. Не забудьте загрузить обновленный кошелек !',
        ALERT_UPGRADE_SUCCESS: 'Кошелек успешно обновлен !',
        ALERT_SIGNATURE_SUCCESS: 'Транзакция успешно выполнена !',
        ALERT_NTY_FILE_SUCCESS: 'Файл nty загружен !',
        ALERT_INCOMING_TX_FROM: 'Входящие транзакции из ',
        ...
        // LOGIN MODULE
        LOGIN_MEMBER_TITLE: 'Уже нэмовец?',
        LOGIN_UPGRADE_TITLE: 'Кошельку необходимо обновиться',
        LOGIN_UPGRADE_MESSAGE: 'Выбранному кошельку необходимы обновления. Это действие приведет к генерации дочернего публичного ключа и добавления его в ваш аккаунт. Загрузка обновленного кошелька будет автоматически срабатывать, вам <b><u>нужно</u></b> скачать его !',
        LOGIN_UPGRADE_BUTTON: 'Обновление кошелька',
        LOGIN_IMPORT_BUTTON: 'Импортировать кошелек',
        LOGIN_SELECT_WALLET: 'Выберите кошелек на локальном устройстве',
        ...
        // FORM RELATED
        FORM_PASSWORD_FIELD_PLACEHOLDER: 'Введите пароль от кошелька или кодовую фразу ',
        FORM_WALLET_NAME_FIELD_PLACEHOLDER: 'Название кошелька',
        FORM_SIGNUP_PASSWORD_FIELD_PLACEHOLDER: 'Пароль',
        FORM_CONFIRM_PASSWORD_FIELD_PLACEHOLDER: 'Подтвердите свой пароль',
        FORM_PASSPHRASE_FIELD_PLACEHOLDER: 'Кодовая фраза',
        FORM_CONFIRM_PASSPHRASE_FIELD_PLACEHOLDER: 'Подтвердите свою кодовую фразу',
        ...
        FORM_SIDE_BTN_PAY_TO: 'Оплатить',
        FORM_SIDE_BTN_TX_FEE: 'Комиссия за перевод',
        FORM_SIDE_BTN_RENTAL_FEE: 'Арендная плата',
        FORM_SIDE_BTN_LEVY_FEE: 'Пошлина',
        FORM_RECIPIENT_PLACEHOLDER: 'Адрес получателя или @ник',
        FORM_INVOICE_RECIPIENT_PLACEHOLDER: 'Адрес получателя',
        FORM_SIDE_BTN_ALIAS_OF: 'Псевдоним',
        FORM_MESSAGE_PLACEHOLDER: 'Сообдение',
